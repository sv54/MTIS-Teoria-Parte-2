    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services
                .AddSwaggerGen(c =>
                {
                    ...
                    {
                        Version = "1.0.0",
                        Title = "API MTIS - OpenAPI 3.0",
                        Description = "API MTIS - OpenAPI 3.0 (ASP.NET Core 3.1)",
                    ...
                    c.DocumentFilter<BasePathFilter>("/VHJ1_1/MTIS/1.0.0");
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                ...
                c.SwaggerEndpoint("/swagger/1.0.0/swagger.json", "API MTIS - OpenAPI 3.0");

                //TODO: Or alternatively use the original Swagger contract that's included in the static files
                // c.SwaggerEndpoint("/swagger-original.json", "API MTIS - OpenAPI 3.0 Original");
            });
